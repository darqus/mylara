 ...
 */
export const requiredRule = (message = 'Обязательно для заполнения') =>
 ...
 * @returns Validation rule function
 */
export const emailRule = (message = 'Введите корректный email адрес') =>
 ...
 * @returns Validation rule function
 */
export const minLengthRule = (length: number, message?: string) =>
  (val: string): boolean | string =>
    !val || val.length >= length || message || `Минимальная длина - ${length} символов`
 ...
 * @returns Validation rule function
 */
export const maxLengthRule = (length: number, message?: string) =>
  (val: string): boolean | string =>
    !val || val.length <= length || message || `Максимальная длина - ${length} символов`
 ...
 * @returns Validation rule function
 */
export const minRule = (min: number, message?: string) =>
  (val: number): boolean | string =>
    val === null || val === undefined || val >= min || message || `Минимальное значение - ${min}`
 ...
 * @returns Validation rule function
 */
export const maxRule = (max: number, message?: string) =>
  (val: number): boolean | string =>
    val === null || val === undefined || val <= max || message || `Максимальное значение - ${max}`
 ...
 * @returns Validation rule function
 */
export const dateFormatRule = (message = 'Введите дату в формате ДД.ММ.ГГГГ') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const wordRule = (message = 'Допустимы только буквы') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const singleWordRule = (message = 'Должно содержать только одно слово (без пробелов)') =>
  (val: string): boolean | string =>
    !val || REGEXP.SINGLE_WORD.test(val) || message
 ...
 * @returns Validation rule function
 */
export const multipleWordsRule = (message = 'Допустимы буквы и пробелы') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const validDateRule = (message = 'Введите корректную дату') =>
  (val: string): boolean | string => {
    if (!val) {return true}

    // Check format first with regex
    if (!REGEXP.DATE.test(val)) {return message}
 ...
 * @returns Validation rule function
 */
export const hasUppercaseRule = (message = 'Пароль должен содержать хотя бы одну заглавную букву') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const hasDigitRule = (message = 'Пароль должен содержать хотя бы одну цифру') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const phoneRule = (message = 'Введите корректный номер телефона') =>
  (val: string): boolean | string =>
 ...
 * @returns Validation rule function
 */
export const birthDateAgeRangeRule = (minAge: number, maxAge: number, message?: string) =>
  (val: string): boolean | string => {
    if (!val) {return true}

    // Check format first with regex
    if (!REGEXP.DATE.test(val)) {return message || 'Введите дату в формате ДД.ММ.ГГГГ'}
